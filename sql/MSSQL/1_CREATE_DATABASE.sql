/* 
!!!! Открыть скрипт SSMS и выбрать -> Query -> SQLCMD Mode
Скрипт развертывания для DatabaseTestDB 
*/
GO
...
GO
:setvar DatabaseName "DatabaseTestDB"
:setvar DefaultFilePrefix "DatabaseTestDB"
